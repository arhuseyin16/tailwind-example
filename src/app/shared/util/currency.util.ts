...
export class CurrencyUtil {
  ...
  static getCurrencySymbolUtilByName(name: CurrencyEnum, value: number): string {
    if (name === CurrencyEnum.TRY) {
      ...
      return new Intl.NumberFormat('sfb', {style: 'currency', currency: CurrencyEnum.EUR}).format(value);
    } else if (name === CurrencyEnum.GBP) {
      ...
      return new Intl.NumberFormat('sfb', {style: 'currency', currency: CurrencyEnum.CHF}).format(value);
    } else if (name === CurrencyEnum.RUB) {
      return new Intl.NumberFormat('sfb', {style: 'currency', currency: CurrencyEnum.RUB}).format(value);
    } else if (name === CurrencyEnum.AUD) {
      ...
      return new Intl.NumberFormat('sfb', {style: 'currency', currency: CurrencyEnum.AED}).format(value);
    }
  }
}
